...
\
\
The graphs above are all from countries within our top 20 list. I've organized it a bit so that the first row is all Asian countries, and vast majority of Asian people in state posses a higher education degree, especially the percentage of people having a master or doctorate degree are around 20%, or even goes up to 40% like India, which is way higher than the native Americans. And as we see before, the era of Asian evasion has just began, a lot of well-educated Asian people are coming into US.
\
