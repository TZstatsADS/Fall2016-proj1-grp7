...
dropout_comparison = data.frame(edu_level = rep(seq(4,14),3), drop_out_rate = c(native_dropout_rate, foreign_dropout_rate), indicator = c(rep('native',11,),rep('foreign',11)))
