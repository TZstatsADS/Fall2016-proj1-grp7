...
Firstly choose the varaibles we are intersted in: 
After comparing the variables, we chose Class of Worker(COW),Employment Status Record(ESR) and Industry Field Record (INDP) as three attributes to evalute the employment situations of the immigrants in the U.S.
\
```
#Load data and select variables:
...
```
\\From the above Class of Workers graph, we may conclude that Mexico has significant high level of people who immigrate to the U.S working for wages. An interesting result also show that Germany has the most immigrants to who work in the U.S.for self-employed in their own but not incorporated companies.
...
\\As we can see from the employment status recode graph, Mexican people surplus other countries of the total immigrants to the U.S. The civilian employed at work and not in labor force also take a large percentage. Chins ranks second and the other three countries all have the similar patterns, showing that people who are civilian employed and at work and not in labor force are the main status of the migrants in the U.S.
